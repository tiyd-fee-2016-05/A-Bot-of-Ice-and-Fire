...
if (commandtext == "@help") {
  ...
  $(".entry").append('<li class="response">' + "How can I help?"+ '</li>')
  $(".entry").append('<li class="response">' + "@background (change the window's color)"+ '</li>')
  $(".entry").append('<li class="response">' + "@gif (search the Seven Kingdoms for gifs)"+ '</li>')
  $(".entry").append('<li class="response">' + "@a-song-of-ice-and-fire (hear what Westeros is listening to) "+ '</li>')
